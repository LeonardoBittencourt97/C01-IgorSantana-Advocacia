    ...
    <footer className="bg-bg border-t border-border">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm font-serif text-gold">{company.tagline}</p>
            ...
            <div className="mt-4 flex gap-3">
              {socialLinks.map(({ href, icon: Icon, label }) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-full border border-border text-text-secondary transition-colors hover:border-gold hover:text-gold"
                >
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 sm:flex-row sm:px-6 lg:px-8">
          ...
          <p className="text-xs text-text-secondary">{company.oab}</p>
        </div>
      </div>
    </footer>
  );
