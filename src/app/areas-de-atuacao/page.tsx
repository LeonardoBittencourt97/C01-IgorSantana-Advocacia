...
import { services, company, seo } from "@/lib/constants";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: `Áreas de Atuação | ${company.name}`,
    description:
      "Especialização em Direito do Trabalho: acidente de trabalho, vínculo empregatício, estabilidade e mais.",
    url: `${seo.url}/areas-de-atuacao`,
  },
...
export default function AreasDeAtuacaoPage() {
  const whatsappUrl = `https://wa.me/${company.phoneWa}?text=${encodeURIComponent(company.whatsappMessage)}`;
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <ScrollReveal delay={0.1}>
            <h1 className="mt-6 font-serif text-4xl md:text-5xl lg:text-6xl font-semibold mb-6">
              Áreas de{" "}
