...
import { company, experience, education, oabCommission, seo } from "@/lib/constants";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Dr. ${company.shortName} — ${company.name}`,
      },
    ],
  },
        ...
        <div className="relative mx-auto max-w-5xl px-4 text-center">
          ...
          <ScrollReveal delay={0.3}>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-text-secondary">
              Advogado trabalhista comprometido com a justiça e a defesa dos
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            <ScrollReveal direction="right" delay={0.2}>
              <p className="text-lg leading-relaxed text-text-secondary">
                Sua atuação é pautada por valores fundamentais que orientam cada
                decisão e cada orientação jurídica prestada aos seus clientes.
              </p>
            </ScrollReveal>
            <ScrollReveal direction="right" delay={0.3}>
              <div className="grid grid-cols-3 gap-4 pt-4">
                {[
                  ...
                  <div
                    key={i}
                    className="flex flex-col items-center gap-2 rounded-lg border border-border bg-bg-card p-4 text-center transition-colors hover:border-gold/30"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-border-subtle bg-bg-elevated p-4">
                    ...
                    <p className="italic text-text-secondary">
                      &ldquo;A advocacia vai além do processo — é um compromisso
                      com a transformação social e o desenvolvimento sustentável
                      do trabalho.&rdquo;
                    </p>
                  </div>
                </div>
          ...
          <ScrollReveal>
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-xl text-text-secondary">
                Trajetória construída com dedicação e compromisso com a
                excelência jurídica.
              </p>
            </div>
          </ScrollReveal>
              ...
              {experience.map((exp, i) => (
                <ScrollReveal key={i} delay={i * 0.1}>
                  <div className="group relative rounded-2xl border border-border bg-bg p-6 transition-all hover:border-gold/30 sm:pl-20 card-hover md:pl-20">
                    <div
                      className="absolute left-0 top-6 hidden h-4 w-4 rounded-full border-2 border-gold bg-bg transition-all group-hover:scale-125 group-hover:bg-gold md:block"
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-20 text-center">
          ...
          <ScrollReveal delay={0.1}>
            <p className="mx-auto mt-4 max-w-xl text-lg text-text-secondary">
              Entre em contato e descubra como podemos ajudá-lo a garantir seus
              direitos.
            </p>
          </ScrollReveal>
          <ScrollReveal delay={0.2}>
